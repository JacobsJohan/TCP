...
# Title: Musichazelpipkin
# Generated: Thu Apr 11 11:43:32 2019
##################################################
...
class musicHazelPipkin(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Musichazelpipkin")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Musichazelpipkin")
        ...
        self.settings = Qt.QSettings("GNU Radio", "musicHazelPipkin")
        ...
        self.analog_const_source_x_1_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 4.830)
        self.analog_const_source_x_1 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 4.765)
...
def main(top_block_cls=musicHazelPipkin, options=None):
