...
class music(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Music")
        ...
        self.settings = Qt.QSettings("GNU Radio", "music")
...
def main(top_block_cls=music, options=None):
